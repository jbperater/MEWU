        		 ...
        		 <?php unset($_SESSION['errMsg']); ?>
                        ...
                        <?php if(isset($records)) : foreach($records as $row) : ?>
									...
									<div class="col-md-4 animate-box">
										...
										<div class="form-group">
											<input style="border:black 1px solid;"type="text" class="form-control" name="new_member_id" value="<?php echo $row->member_id ?>" placeholder="SSS Number*" autocomplete="off" required>
										</div>
										<div class="form-group">
