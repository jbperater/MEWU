...
.dropdown:hover .dropbtn {
	...
	<body>
		<div id="fh5co-wrapper" style="background-image: url(<?php echo base_url();?>assets/images/ssss.jpg);">
		<div id="fh5co-page">
		<div id="fh5co-header">
		...
		<div class="fh5co-hero">
			<div class="fh5co-cover" style="background-image: url(<?php echo base_url();?>assets/images/ssss.jpg);"><br>
            <div class="container">
