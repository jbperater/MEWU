...
input[type=text]:focus {
	...
	<body>
		...
		<div class="fh5co-hero">
			<div class="fh5co-cover" data-stellar-background-ratio="0.5" style="background-image: url(../assets/images/ssss.jpg); height :900px;">
            <div class="container" style="margin-top: -5%; height:850px;">
					<div class="row" style="margin-top: 8%; height:250px; padding-top:30px; background-color: white;">
						<H1 ><b><center><a href="<?php echo base_url();?>auth/home" >GENERAL SERVICES COOPERATIVE</a></center></b></H1>
						...
						?>
							...
							<tr><td style="color:black; padding-left:10px; "><b>Name : </b><?php echo ($records->lastname." ".$records->firstname." ".$records->middlename); ?></td> </tr>
						...
						<h4 style="padding-top:20px;"><center><?php echo $year-1 ?> CONTRIBUTION</center></h4>
                        <table id="miyazaki" border="1px" width="100%" >
                        <br>
                        <thead>
						<tr><th>January<th>February<th>March<th>April<th>May<th>June<th>July<th>August<th>September<th>October<th>November<th>December<th><center>Remarks
						<tbody>
                        <?php
								$count_month=12;
								$loop_month=0;
                        ...
                        <h4 style="padding-top:20px;"><center><?php echo $year ?> CONTRIBUTION</center></h4>
                        <table id="miyazaki" border="1px" width="100%" >
                        <thead>
						<tr><th>January<th>February<th>March<th>April<th>May<th>June<th>July<th>August<th>September<th>October<th>November<th>December<th><center>Remarks
						<tbody>
