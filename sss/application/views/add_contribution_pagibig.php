<!DOCTYPE html>
	...
	<link rel="shortcut icon" href="<?php echo base_url();?>assets/paglogo.jpg">
             ...
             Member's Contribution</h4>
        		 ...
        		 <?php unset($_SESSION['errMsg']); ?>
                        ...
                        <?php if(isset($records)) : foreach($records as $row) : ?>
               		  <form class="contact-form" action="update_contribution_from_admins" method="post">
								...
								<div class="form-group">
               		  				<h4></h4>
									<h4 style="color:black"><b>Pag-IBIG Number: </b><?php echo $row->hdmf; ?></h4>
								</div>
                     			<div class="form-group">
