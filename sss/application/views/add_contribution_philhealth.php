<!DOCTYPE html>
	...
	<link rel="shortcut icon" href="<?php echo base_url();?>assets/phillogo.jpg">
             ...
             Member's Contribution</h4>
        		 ...
        		 <?php unset($_SESSION['errMsg']); ?>
                        ...
                        <?php if(isset($records)) : foreach($records as $row) : ?>
               		  <form class="contact-form" action="update_contribution_from_adminss" method="post">
								...
								<div class="form-group">
               		  				<h4></h4>
									<h4 style="color:black"><b>PhilHealth Number: </b><?php echo $row->philhealth_num; ?></h4>
								</div>
