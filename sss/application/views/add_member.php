             ...
             Member's Personal Information</h4>
        		 ...
        		 <?php unset($_SESSION['errMsg']); ?>
               		  ...
               		  <form class="contact-form" action="save_member_from_admin" method="post">
								...
								<label style="font-size:15px; color:black; ">ID Number</label>
								<div class="form-group">
									<input style="border:black 1px solid;" type="text" class="form-control" name="member_id" placeholder="ID Number*" autocomplete="off" required>
								</div>
								...
								<div class="form-group">
									<input style="border:black 1px solid;" type="text" class="form-control" name="sss_num" placeholder="SSS Number" autocomplete="off" >
								</div>
								<label style="font-size:15px; color:black; ">Philhealth Number*</label>
								<div class="form-group">
									<input style="border:black 1px solid;" type="text" class="form-control" name="philhealth_num" placeholder="Philhealth" autocomplete="off" >
								</div>
								<label style="font-size:15px; color:black; ">Pagibig Number*</label>
								<div class="form-group">
									<input style="border:black 1px solid;" type="text" class="form-control" name="hdmf" placeholder="HDMF" autocomplete="off">
								</div>
								<div class="form-group">
