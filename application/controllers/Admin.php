...
class Admin extends CI_Controller {
	...
	public function search(){
			...
			$config['base_url'] = "http://localhost/mewu/Login_auth_db/search";
			$config['per_page'] = 10;
			$config['num_links'] = 3;
			...
			$data["fetch_data"] = $this->db->get('persons', $config['per_page'], $this->uri->segment(3), $this->db->order_by("person_id", "asc"));
	...
	public function update_account(){
			...
			$this->load->view('update_account',$users);
