...
(1, 'Aircon', 'Acer', 'AD156', '123243', 'ITB', 'Information Technology', '', '2014');
...
CREATE TABLE `job_req` (
  ...
  `bldg_no` varchar(10) DEFAULT NULL,
...
INSERT INTO `job_req` (`job_id`, `date`, `item_no`, `description`, `bldg_no`, `location`, `date_time_start`, `date_time_fin`, `person_attend`, `remark`, `requested_by`, `approve_by`) VALUES
(3, '2019-01-28 21:13:28', NULL, 'guba ang school', '9', 'room 104', NULL, NULL, NULL, NULL, 1, NULL);
